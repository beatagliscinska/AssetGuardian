"""
Django settings for AssetGuardian project.
...
SECRET_KEY = 'django-insecure-qt)_06bx5$)e0w+0a+zkaz(j-0qq^t4y)8&fyp7gjd(a4(8)&w'
...
ROOT_URLCONF = 'AssetGuardian.urls'
...
WSGI_APPLICATION = 'AssetGuardian.wsgi.application'
